...
/**
 * Вендорные снэпшоты — цельные демо-приложения ("import ... export function
 * App() {...}"), длиннее usage-сниппетов, но всё равно не безлимитные. 900
 * символов обрывали больше четверти примеров (58 из 215), обычно на середине
 * разметки; поднято до общего с usage-примерами потолка.
 */
const MAX_VENDOR_CODE_CHARS = 2400;
