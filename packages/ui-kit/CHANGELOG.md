...
- **Rating:** Добавлен новый компонент.
...
- refactor(atoms)!: приведение размеров и view компонентов к дизайн-макетам ([ca5e8b7](https://stash.dddddd.ru:7999/uvhd-fiori/digital_finance_ui/commits/ca5e8b78198a6a50a7d26e48350a589fba8fccf5))
...
- скорректированы размеры (size) и варианты отображения (view) ряда атомарных компонентов. Изменения приводят типы в соответствие с актуальными макетами — убраны размеры и view, которых не существовало в дизайне, но которые были доступны в коде.
...
commit 0c4d5fc9f0d71c58ba15e4f827d70b3a340efd00
Author: Pavel Potapov <PSerPotapov@bbbb.ru>
Date: Fri May 15 14:35:42 2026 +0300

    nfp-fix: fix types

commit a15fa2d8e62539d955b25a5ba93f06b23711bb82
Author: Pavel Potapov <PSerPotapov@bbbb.ru>
Date: Fri May 15 14:24:57 2026 +0300

    nfp-fix: popoverDF types

commit c7aa14bda7bc6f57c9843b551ceb24f8dd2e355b
Author: Pavel Potapov <PSerPotapov@bbbb.ru>
Date: Fri May 15 14:07:46 2026 +0300

    nfp-feat: добавил fullscreenmode для tableCanvas в генератор метаинформации.

commit 6de7645b9f6bc5cb6b0b3afc1bcf350a54bc647e
Author: Pavel Potapov <PSerPotapov@bbbb.ru>
Date: Fri May 15 14:04:15 2026 +0300

    nfp-fix: fix

commit 0326c861c071bfb025a27aeba154d9a3a85a0729
Merge: 92017fb0 90530312
Author: Pavel Potapov <PSerPotapov@bbbb.ru>
Date: Fri May 15 13:52:00 2026 +0300

    nfp-feat: mr dev

commit 92017fb061d2a489015f5649a67142b8fff568e9
Author: Pavel Potapov <PSerPotapov@bbbb.ru>
Date: Fri May 15 13:49:51 2026 +0300

    feat(TableCanvas): добавлена документация для fullScreenMode фичи

commit 305cc6dfed0d137952409f857ab06a9a84f4a23f
Author: Pavel Potapov <PSerPotapov@bbbb.ru>
Date: Fri May 15 13:33:56 2026 +0300

    nfp-feat: обновление пакетов атомарной команды 340 версия

commit dea841306cd6fd976ba5ec33b94d0253e7e254cd
Author: Pavel Potapov <PSerPotapov@bbbb.ru>
Date: Wed May 13 15:49:21 2026 +0300

    nfp-fix: убрал ненужное

commit 54bc8bdd2f24957ad2bf06260a9d7f3e517bfd94
Author: Pavel Potapov <PSerPotapov@bbbb.ru>
Date: Wed May 13 15:15:05 2026 +0300

    nfp-fix: типы и документация

commit 72ba05ed56cf862ed5468a1bc359e741feb4da7b
Author: Pavel Potapov <PSerPotapov@bbbb.ru>
Date: Wed May 13 13:51:44 2026 +0300

    nfp-fix: правки view сегментов, правки слотов в AnalyticalWidget

commit ae9ff7ca0a2195779c2ac529eb496f1849e79eae
Author: Pavel Potapov <PSerPotapov@bbbb.ru>
Date: Fri May 8 17:17:33 2026 +0300

    nfp-fix: fix styles

commit ff6405b0479d1afcf8c9666cb4446e4aafdd7de9
Author: Pavel Potapov <PSerPotapov@bbbb.ru>
Date: Thu Apr 30 18:53:37 2026 +0300

    nfp-fix: правки линтера

commit c2784f7d65733eb5294679d60107146e26298305
Author: Pavel Potapov <PSerPotapov@bbbb.ru>
Date: Thu Apr 30 18:08:29 2026 +0300

    nfp-feat: поправил типы

commit e4a989b5adb677d2b8e000b2a45d27e6ced6d0d6
Author: Pavel Potapov <PSerPotapov@bbbb.ru>
Date: Thu Apr 30 13:13:26 2026 +0300
...
- **BlockTitle:** DFP-5330 Исправление story после review ([45672fb](https://stash.dddddd.ru:7999/uvhd-fiori/digital_finance_ui/commits/45672fbfd5b70442d077d9d42d9d68e9921a2d92))
- **BlockTitle:** DFP-5330 Исправление после review ([5d31946](https://stash.dddddd.ru:7999/uvhd-fiori/digital_finance_ui/commits/5d319460194fe643b024fd06b86442ac69a6c03f))
- **BlockTitle:** DFP-5330 Исправление после review ([0af9516](https://stash.dddddd.ru:7999/uvhd-fiori/digital_finance_ui/commits/0af95168884f24c199b9555265e6193548d77121))
- **BlockTitle:** DFP-5330 Мелкие исправление ui после review ([773512b](https://stash.dddddd.ru:7999/uvhd-fiori/digital_finance_ui/commits/773512b0522863a4e01ace25b78742c38ef664c4))
