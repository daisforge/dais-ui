...
/**
 * Режим отображения стрелок переключения групп:
 * `auto` — скрыть, если группа одна; иначе показать обе (крайняя disabled);
 * `always` — показывать всегда (крайняя disabled); `never` — не показывать.
 */
...
export interface StoriesProps {
  ...
  /** Режим стрелок переключения групп. По умолчанию `auto` (скрыть при единственной группе). */
