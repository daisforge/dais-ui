...
// Тема beta core (sdds_finai_beta_core, light). База — TOKENS_LIGHT, поверх —
// значения из CSS пакета (имена токенов совпадают). Токены без прямого
// соответствия (opacity-варианты, disabled, часть data-цветов) наследуют light.
const TOKENS_BETA_LIGHT = {
  ...TOKENS_LIGHT,
  textPrimary: '#14191DF5',
  textPrimaryHover: '#151A1E93',
  textPrimaryActive: '#151A1EC4',
  textSecondary: '#475158B0',
  textSecondaryHover: '#465058FF',
  textSecondaryActive: '#465058D3',
  textTertiary: '#707F897A',
  textTertiaryHover: '#707F89FF',
  textTertiaryActive: '#707F8993',
  ...
  textPositive: '#219532',
  textPositiveHover: '#28B83EFF',
  textPositiveActive: '#1A7527FF',
  textWarning: '#E15400',
  textWarningHover: '#FF640AFF',
  textWarningActive: '#B84300FF',
  textNegative: '#D60033',
  textNegativeHover: '#FF003BFF',
  textNegativeActive: '#AD0028FF',
  inverseTextPrimary: '#F3F7FAF5',
  onDarkTextPrimary: '#F3F7FAF5',
  onDarkTextPrimaryHover: '#F4F8FA93',
  onDarkTextPrimaryActive: '#F4F8FAC4',
  onLightTextPrimary: '#14191DF5',
  onLightTextPrimaryHover: '#151A1E93',
  onLightTextPrimaryActive: '#151A1EC4',
  surfaceAccentMinor: '#EFF8FF',
  surfaceSolidDefault: '#060A0D',
  surfaceSolidTertiary: '#CFDBE4',
  surfaceAccent: '#1F9EEB',
  surfaceAccentHover: '#3AA9EEFF',
  surfaceAccentActive: '#1492E1FF',
  surfaceTransparentSecondary: '#A8B6BF38',
  surfaceTransparentSecondaryHover: '#A7B5BE47',
  surfaceTransparentSecondaryActive: '#A7B5BE4D',
  surfaceTransparentTertiary: '#8B98A247',
  surfaceTransparentDeep: '#30383EC7',
  surfacePositive: '#21A038',
  surfacePositiveHover: '#24B23EFF',
  surfacePositiveActive: '#1D9032FF',
  surfaceWarning: '#E15400',
  surfaceWarningHover: '#F55A00FF',
  surfaceWarningActive: '#CC4B00FF',
  surfaceNegative: '#F81C42',
  ...
  onLightSurfaceSolidDefault: '#060A0D',
  onLightSurfaceTransparentDeep: '#30383EC7',
  onDarkSurfaceSolidDefault: '#F6F9FB',
  outlineAccent: '#0087CD',
  outlineSolidPrimary: '#CFDBE4',
  dataBlueMinor: '#D3EBFF',
  dataBlueMinorActive: '#C2E3FFFF',
  dataBlue: '#1F9EEB',
  dataOrange: '#F3621C',
  dataOrangeMinor: '#F79772',
  dataPink: '#FC8CA6',
} as const;
