      ...
      >
        ...
        {(hasInlineCollapse ||
          ...
          <Flow
            ...
            style={{
              flexWrap: 'nowrap',
              // Левая зона занимает строго ширину своего содержимого. Без явного
              // flex её может растянуть окружение (например flex: 1 1 100% из
              // стилей приложения), и тогда она отжимает поиск к центру, а при
              // схлопывании поля — к правому краю контрл-блока.
              flex: '0 0 auto',
            }}
          >
            {hasInlineCollapse && (
