export const tableSidebarClassNames = {
  tableSidebarLayout: 'rdg-table-sidebar-layout',
  tableSidebarTableContainer: 'rdg-table-sidebar-layout-table-container',
  tableSidebarToggleIcon: 'rdg-table-sidebar-layout__toggle-icon',
