...
- `BlockGradientScroll` — React-компонент (`@dais-ui/ui-kit`)
- `BlockGradientScrollProps` — Тип пропсов (`@dais-ui/ui-kit`)

### Миксин

- `BlockGradientScrollMixin` — Основной миксин (`@dais-ui/ui-kit/mixins`)
- `BlockGradientScrollPadding` — Тип для padding (`@dais-ui/ui-kit/mixins`)
- `BlockGradientScrollVariant` — Тип для variant (`@dais-ui/ui-kit/mixins`)
- `BlockGradientScrollOptions` — Тип опций миксина (`@dais-ui/ui-kit/mixins`)
...
<Source language="tsx" code={`
import { BlockGradientScroll } from '@dais-ui/ui-kit';
...
<Source language="tsx" code={`
import { BlockGradientScrollMixin } from '@dais-ui/ui-kit/mixins';
