...
/**
 * ### 1. XS: Все фичи — Collapsing (above) + TableTabs + ControlBlock
 */
export const XSAllFeaturesWithTabs: Story = {
...
/**
 * ### 2. XS: TableTabs + ControlBlock (без коллапсинга)
 */
export const XSTabsWithoutCollapsing: Story = {
  ...storySourceDoc({ preCode, previewSource: 'shown' }),
...
/**
 * ### 3. XS: Collapsing (above) + ControlBlock (без табов)
 */
export const XSCollapsingAboveNoTabs: Story = {
  ...storySourceDoc({ preCode, previewSource: 'shown' }),
...
/**
 * ### 4. XS: ControlBlock inline collapsing
 */
export const XSInlineCollapsing: Story = {
  ...storySourceDoc({ preCode, previewSource: 'shown' }),
...
/**
 * ### 5. XS: Title above (без коллапсинга)
 */
export const XSTitleBlockStory: Story = {
  ...storySourceDoc({ preCode, previewSource: 'shown' }),
...
/**
 * ### 5b. XS: Title inline (заголовок внутри controlBlock)
 */
export const XSTitleBlockInline: Story = {
  ...storySourceDoc({ preCode, previewSource: 'shown' }),
