...
import { IconRefresh, IconResetOutline, IconSber } from '@ui-kit/icons';
import React, { useCallback, useMemo, useState } from 'react';
import { SortColumn } from 'react-data-grid'; // TODO: спросить у Рамиля про импорт
import styled from 'styled-components';

const meta: Meta = {
  title: 'Локальные компоненты/Table/MultipleFeatures',
  tags: ['!autodocs'],
  parameters: {
    docs: {
