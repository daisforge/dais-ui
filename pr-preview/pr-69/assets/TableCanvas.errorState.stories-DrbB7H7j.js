import{d as C,r as d}from"./react-D2T61mpp.js";import{s as m}from"./storySourceDoc-tVKyHcEN.js";import{T as g}from"./TableCanvas-FGNYaj3V.js";const S=700,M=1200,E=[],o=[{key:"id",name:"ID"},{key:"name",name:"Сотрудник"},{key:"status",name:"Статус"},{key:"team",name:"Команда"}],k=[{key:"employee-group",name:"Сотрудник",children:[{key:"id",name:"ID"},{key:"name",name:"ФИО"}]},{key:"meta-group",name:"Статус и команда",children:[{key:"status",name:"Статус"},{key:"team",name:"Команда"}]}],L=[];function f(e,u){const[n,t]=d.useState(!0),[v,b]=d.useState(e);return d.useEffect(()=>{t(!0),b(e);const w=setTimeout(()=>{b(u),t(!1)},M);return()=>{clearTimeout(w)}},[u,e]),{columnConfig:v,isLoading:n}}const Y={title:"Локальные компоненты/TableCanvas/ErrorState",tags:["!autodocs"],parameters:{docs:{description:{component:"Все demo-сценарии специально проходят через loading, чтобы в Storybook не было промежуточного broken-image кадра у ErrorPage/EmptyState."}}}},p=`
