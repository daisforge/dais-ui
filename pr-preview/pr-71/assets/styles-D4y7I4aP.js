import{r as y,d as a}from"./react-D2T61mpp.js";import{d as V}from"./utils-DPEqGdFs.js";import{C as m,W as i,H as E}from"./styled-components-CR-x_nln.js";import{cq as P,cj as j,cr as R,ck as B,cs as q,ci as M,ct as W,cl as A,x as F,aI as O,cu as v,cv as _}from"./@salutejs/sdds-themes-p9DCXULv.js";import{g as h}from"./mixins-B6ztv_vs.js";import{m as H,c as z}from"./@salutejs/plasma-typo-BGP0S5OL.js";import{s as k}from"./EXTERNAL_PACKAGE_MODULE_sdds_finai_high_contrast__light_theme-uTSVIbRM.js";import{s as D}from"./@salutejs-ds/sdds_finai_high_contrast-DoAS7YWi.js";import{s as N,a as T}from"./@salutejs-ds/sdds_finai_beta_core-CRX1TY7Q.js";const r="dais-ui__",u="notification-wrapper",X="notification-text",p="notification-title",s={wrapper:`${r}notification`,positive:`${r}notification--positive`,negative:`${r}notification--negative`,warning:`${r}notification--warning`,info:`${r}notification--info`,hasBackground:`${r}notification--has-background`,hasTitleColor:`${r}notification--has-title-color`,hasBorderColor:`${r}notification--has-border-color`},U={positive:{background:A,borderColor:W},negative:{background:M,borderColor:q},warning:{background:B,borderColor:R},info:{background:j,borderColor:P}},C=()=>Object.entries(U).map(([e,t])=>{const o=s[e];return m`
