import{r as i,d as e}from"./react-D2T61mpp.js";import{c as E}from"./tableData-UCfjiBCh.js";import I from"./DocStoryTemplate-oNxBpJHV.js";import{s as f}from"./storySourceDoc-tVKyHcEN.js";import{T as k}from"./TableCanvas-CbSlA78G.js";import{b as d,a2 as c}from"./@salutejs/sdds-finai-BMyiwTu5.js";const _={title:"Локальные компоненты/TableCanvas/HighlightActiveType",parameters:{docs:{page:I}},tags:["!autodocs"]},O=["row","disabled"],B=["range-cell","multi-range-cell","cell","disabled"],M=["big","medium","small"],F={big:48,medium:32,small:24},N=[{key:"id",name:"ID",width:90},{key:"task",name:"Title",width:260},{key:"priority",name:"Priority",width:180},{key:"issueType",name:"Issue Type",width:180},{key:"complete",name:"% Complete",width:160}],g=t=>t.id+t.issueType,x=`
import {
  type ColumnConfig,
