import{d as e,r as c}from"./react-D2T61mpp.js";import{g as b}from"./getFuncAsString-Bp1PYzKJ.js";import{s as d}from"./storySourceDoc-tVKyHcEN.js";import{P as t}from"./PopoverDF-BwAcfzLT.js";import{s as y}from"./constants-DM2G2kGu.js";import{cx as ee,cL as N,cK as w,b0 as S}from"./@salutejs/sdds-themes-CZ516YZq.js";import{b as l,F as oe}from"./@salutejs/sdds-finai-BMyiwTu5.js";const re={m:"xs",s:"xxs"},se=["top","top-start","top-end","right","right-start","right-end","bottom","bottom-start","bottom-end","left","left-start","left-end"],te=["top","top-right","right","bottom-right","bottom","bottom-left","left","top-left"],ie=["top-left","top-right","bottom-left","bottom-right"],o={control:!1,table:{disable:!0}},ne={size:o,target:o,placement:o,trigger:o,defaultOpened:o,opened:o,onToggle:o,hasTail:o,flip:o,shift:o,offset:o,outsideClick:o,delayOpen:o,delayClose:o,showCloseButton:o,withHeaderSlot:o,withBody:o,withFooter:o,resizable:o,resizableDisabled:o,resizableDirections:o,resizableHiddenIcons:o,resizableDefaultSize:o,resizableMinWidth:o,resizableMinHeight:o,resizableMaxWidth:o,resizableMaxHeight:o,resizableIconSize:o},z=`import { useState } from 'react';
