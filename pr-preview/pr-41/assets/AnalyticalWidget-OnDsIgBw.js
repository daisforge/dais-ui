import{d as t,r as f}from"./react-D2T61mpp.js";import{I as au,W as nu,y as lu,x as R,p as ou,ao as ru,w as b,ap as du}from"./@salutejs/sdds-themes-DMMPng_c.js";import{H as a,C as T}from"./styled-components-rNTPyvwi.js";import{c as su,d as pu,e as cu,f as mu,H as fu,g as gu,h as yu,i as hu,j as Eu,k as xu,l as Du,m as Au,n as vu,o as Bu,p as Nu,q as X,r as Fu,s as P,t as wu,D as bu,C as Cu,u as ku,L as Tu}from"./@salutejs/sdds-finai-BCLo0Wa_.js";import{e as Wu,a as _,u as _u,m as A}from"./utils-CssElEth.js";import{I as Su}from"./IconButton-BW1UuVlC.js";import{i7 as Vu,i5 as Hu,kX as qu}from"./@salutejs/plasma-icons-D6Arjyth.js";import{C as Iu}from"./Collapse-DpDeoG2B.js";const Lu={BodyL:Fu,BodyM:X,BodyS:Nu,BodyXS:Bu,BodyXXS:vu,DsplL:Au,DsplM:Du,DsplS:xu,H1:Eu,H2:hu,H3:yu,H4:gu,H5:fu,TextL:mu,TextM:cu,TextS:pu,TextXS:su};function B({variant:u,children:e,refTypography:l,...o}){const n=Lu[u];return t.jsxDEV(n,{...o,ref:l,children:e},void 0,!1,{fileName:"/home/runner/work/dais-ui/dais-ui/packages/ui-kit/src/components/Typography/Typography.tsx",lineNumber:63,columnNumber:5},this)}B.displayName="Typography";try{B.displayName="Typography",B.__docgenInfo={description:"",displayName:"Typography",props:{variant:{defaultValue:null,description:"",name:"variant",required:!0,type:{name:"enum",value:[{value:'"BodyL"'},{value:'"BodyM"'},{value:'"BodyS"'},{value:'"BodyXS"'},{value:'"BodyXXS"'},{value:'"DsplL"'},{value:'"DsplM"'},{value:'"DsplS"'},{value:'"H1"'},{value:'"H2"'},{value:'"H3"'},{value:'"H4"'},{value:'"H5"'},{value:'"TextL"'},{value:'"TextM"'},{value:'"TextS"'},{value:'"TextXS"'}]}},refTypography:{defaultValue:null,description:"",name:"refTypography",required:!1,type:{name:"LegacyRef<HTMLDivElement>"}}}}}catch{}const C="typography-with-auto-tooltip-root";let v=!1,x=null,w=0;function Y(){if(typeof document>"u")return;const u=document.getElementById(C);u&&u.querySelectorAll("[id^='plasma-popover-root']:empty").forEach(e=>e.remove())}function Ru(){v||(v=!0,x=setTimeout(()=>{v=!1,x=null,Y()},0))}function Pu(){x&&(clearTimeout(x),x=null),v=!1}function $u(){x&&(clearTimeout(x),x=null),v=!1,Y()}function ju(){if(!(typeof document>"u")){if(w+=1,w===1){const u=document.createElement("div");u.id=C,document.body.appendChild(u)}return()=>{if(w-=1,w===0){const u=document.getElementById(C);u&&(u.querySelectorAll("[id^='plasma-popover-root']").length>0||u.remove())}}}}function S(){return{schedule:Ru,flush:$u,cancel:Pu,getContainerId:()=>C,createContainer:ju}}try{S.displayName="usePopoverCleanup",S.__docgenInfo={description:`Возвращает { schedule, flush, cancel, getContainerId, createContainer } — SingleTone
...
`,G=({groupLabel:u,items:e,children:l,fullWidth:o,...n})=>{const d=e.length>0,i=t.jsxDEV(P,{usePortal:!0,size:"s",mouseEnterDelay:500,...n,trigger:d?n.trigger??"hover":"none",text:d?t.jsxDEV(Mu,{groupLabel:u,items:e},void 0,!1,{fileName:"/home/runner/work/dais-ui/dais-ui/packages/ui-kit/src/components/Tooltip/TooltipList.tsx",lineNumber:93,columnNumber:11},void 0):null,opened:d?n.opened:!1,children:l},void 0,!1,{fileName:"/home/runner/work/dais-ui/dais-ui/packages/ui-kit/src/components/Tooltip/TooltipList.tsx",lineNumber:84,columnNumber:5},void 0);return o?t.jsxDEV(zu,{children:i},void 0,!1,{fileName:"/home/runner/work/dais-ui/dais-ui/packages/ui-kit/src/components/Tooltip/TooltipList.tsx",lineNumber:103,columnNumber:12},void 0):i};try{G.displayName="TooltipList",G.__docgenInfo={description:"",displayName:"TooltipList",props:{groupLabel:{defaultValue:null,description:"",name:"groupLabel",required:!1,type:{name:"string"}},items:{defaultValue:null,description:"",name:"items",required:!0,type:{name:"string[]"}},fullWidth:{defaultValue:null,description:`Растягивает внутренние обёртки Tooltip (popover-target, popover-wrapper) на 100% ширины родителя.
Используйте при размещении TooltipList внутри Popover-контента (например, FiltersActions.FiltersButtonWithPopover),
чтобы дочерний элемент (Combobox и т.д.) занимал всю доступную ширину.`,name:"fullWidth",required:!1,type:{name:"boolean"}}}}}catch{}const V=a(P)`
  &.popover-target {
    width: 100%;
  }
`,H=a.div`
...
`,t4=a(Cu)`
  ...
  padding-top: 8px;
`,I=({chips:u,commonView:e="default",commonSize:l="xs",opened:o=!1,...n})=>{const d=_u(o,300,!1),i=f.useRef(u);u.length>0&&(i.current=u);const g=u.length>0?u:i.current;return t.jsxDEV("div",{className:r.selfSpacedTopSlot,children:t.jsxDEV(Iu,{isOpen:d,unMountOnClose:!0,children:t.jsxDEV(t4,{view:e,size:l,isCommonChipStyles:!1,...n,children:g.map(({key:s,view:y,...p},D)=>f.createElement(e4,{size:"xs",appearance:"transparent",...p,key:s??`${p==null?void 0:p.name}-${D}`}))},void 0,!1,{fileName:"/home/runner/work/dais-ui/dais-ui/packages/ui-kit/src/components/AnalyticalWidget/components/AnalyticalWidgetChips/AnalyticalWidgetChipsGroup.tsx",lineNumber:31,columnNumber:9},void 0)},void 0,!1,{fileName:"/home/runner/work/dais-ui/dais-ui/packages/ui-kit/src/components/AnalyticalWidget/components/AnalyticalWidgetChips/AnalyticalWidgetChipsGroup.tsx",lineNumber:30,columnNumber:7},void 0)},void 0,!1,{fileName:"/home/runner/work/dais-ui/dais-ui/packages/ui-kit/src/components/AnalyticalWidget/components/AnalyticalWidgetChips/AnalyticalWidgetChipsGroup.tsx",lineNumber:29,columnNumber:5},void 0)};try{I.displayName="AnalyticalWidgetChipsGroup",I.__docgenInfo={description:"",displayName:"AnalyticalWidgetChipsGroup",props:{chips:{defaultValue:null,description:"Пропсы для чипов",name:"chips",required:!0,type:{name:"any[]"}},commonView:{defaultValue:{value:"default"},description:"",name:"commonView",required:!1,type:{name:"enum",value:[{value:'"default"'},{value:'"clear"'},{value:'"accent"'}]}},commonSize:{defaultValue:{value:"xs"},description:"",name:"commonSize",required:!1,type:{name:"enum",value:[{value:'"s"'},{value:'"xs"'},{value:'"m"'}]}},opened:{defaultValue:{value:"false"},description:"",name:"opened",required:!1,type:{name:"boolean"}}}}}catch{}const i4=()=>T(du),K=()=>T(ru),a4=a.header`
  display: flex;
...
`;const c4=a.div`
  align-self: start;
  flex-shrink: 0;
`,k=({title:u,titleTooltipProps:e})=>typeof u!="string"?t.jsxDEV(t.Fragment,{children:u},void 0,!1,{fileName:"/home/runner/work/dais-ui/dais-ui/packages/ui-kit/src/components/AnalyticalWidget/components/AnalyticalWidgetHeader/AnalyticalWidgetTitle.tsx",lineNumber:12,columnNumber:12},void 0):t.jsxDEV(o4,{tooltipText:u,tooltipProps:{placement:"top",...e},variant:"BodyM",bold:!0,style:{color:R,wordBreak:"normal"},lines:1,children:u},void 0,!1,{fileName:"/home/runner/work/dais-ui/dais-ui/packages/ui-kit/src/components/AnalyticalWidget/components/AnalyticalWidgetHeader/AnalyticalWidgetTitle.tsx",lineNumber:16,columnNumber:5},void 0);try{k.displayName="AnalyticalWidgetTitle",k.__docgenInfo={description:"",displayName:"AnalyticalWidgetTitle",props:{title:{defaultValue:null,description:`Заголовок. Строка обрезается троеточием с Tooltip; произвольный ReactNode
...
Пропсы для компонента Link, который оборачивает заголовок.`,name:"titleLinkProps",required:!1,type:{name:'Omit<LinkCompProps, "ref">'}}}}}catch{}const L=({title:u,titleTooltipProps:e,badge:l,badgeStyles:o,subtitle:n,subtitleTooltipProps:d,infoTooltipText:i,infoTooltipProps:g,rightSlot:s,className:y,titleLinkProps:p})=>t.jsxDEV(a4,{className:A(r.header,y),children:[t.jsxDEV(n4,{children:[t.jsxDEV(l4,{children:[u&&p?t.jsxDEV(p4,{underline:"none",...p,children:t.jsxDEV(k,{title:u,titleTooltipProps:e},void 0,!1,{fileName:"/home/runner/work/dais-ui/dais-ui/packages/ui-kit/src/components/AnalyticalWidget/components/AnalyticalWidgetHeader/AnalyticalWidgetHeader.tsx",lineNumber:38,columnNumber:13},void 0)},void 0,!1,{fileName:"/home/runner/work/dais-ui/dais-ui/packages/ui-kit/src/components/AnalyticalWidget/components/AnalyticalWidgetHeader/AnalyticalWidgetHeader.tsx",lineNumber:37,columnNumber:11},void 0):t.jsxDEV(k,{title:u,titleTooltipProps:e},void 0,!1,{fileName:"/home/runner/work/dais-ui/dais-ui/packages/ui-kit/src/components/AnalyticalWidget/components/AnalyticalWidgetHeader/AnalyticalWidgetHeader.tsx",lineNumber:44,columnNumber:11},void 0),l&&t.jsxDEV(d4,{style:o,children:l},void 0,!1,{fileName:"/home/runner/work/dais-ui/dais-ui/packages/ui-kit/src/components/AnalyticalWidget/components/AnalyticalWidgetHeader/AnalyticalWidgetHeader.tsx",lineNumber:50,columnNumber:11},void 0),i&&t.jsxDEV(s4,{children:t.jsxDEV(P,{trigger:"hover",placement:"top",text:i,target:t.jsxDEV(qu,{size:"xs",style:{cursor:"pointer",color:b}},void 0,!1,{fileName:"/home/runner/work/dais-ui/dais-ui/packages/ui-kit/src/components/AnalyticalWidget/components/AnalyticalWidgetHeader/AnalyticalWidgetHeader.tsx",lineNumber:59,columnNumber:17},void 0),className:A(r.popoverInfo),...g},void 0,!1,{fileName:"/home/runner/work/dais-ui/dais-ui/packages/ui-kit/src/components/AnalyticalWidget/components/AnalyticalWidgetHeader/AnalyticalWidgetHeader.tsx",lineNumber:54,columnNumber:13},void 0)},void 0,!1,{fileName:"/home/runner/work/dais-ui/dais-ui/packages/ui-kit/src/components/AnalyticalWidget/components/AnalyticalWidgetHeader/AnalyticalWidgetHeader.tsx",lineNumber:53,columnNumber:11},void 0)]},void 0,!0,{fileName:"/home/runner/work/dais-ui/dais-ui/packages/ui-kit/src/components/AnalyticalWidget/components/AnalyticalWidgetHeader/AnalyticalWidgetHeader.tsx",lineNumber:35,columnNumber:7},void 0),n&&(typeof n=="string"?t.jsxDEV(r4,{variant:"BodyXS",tooltipText:n,style:{color:b,wordBreak:"normal"},tooltipProps:{placement:"top",...d},lines:1,children:n},void 0,!1,{fileName:"/home/runner/work/dais-ui/dais-ui/packages/ui-kit/src/components/AnalyticalWidget/components/AnalyticalWidgetHeader/AnalyticalWidgetHeader.tsx",lineNumber:75,columnNumber:11},void 0):n)]},void 0,!0,{fileName:"/home/runner/work/dais-ui/dais-ui/packages/ui-kit/src/components/AnalyticalWidget/components/AnalyticalWidgetHeader/AnalyticalWidgetHeader.tsx",lineNumber:34,columnNumber:5},void 0),s&&t.jsxDEV(c4,{children:s},void 0,!1,{fileName:"/home/runner/work/dais-ui/dais-ui/packages/ui-kit/src/components/AnalyticalWidget/components/AnalyticalWidgetHeader/AnalyticalWidgetHeader.tsx",lineNumber:94,columnNumber:19},void 0)]},void 0,!0,{fileName:"/home/runner/work/dais-ui/dais-ui/packages/ui-kit/src/components/AnalyticalWidget/components/AnalyticalWidgetHeader/AnalyticalWidgetHeader.tsx",lineNumber:33,columnNumber:3},void 0);try{L.displayName="AnalyticalWidgetHeader",L.__docgenInfo={description:"",displayName:"AnalyticalWidgetHeader",props:{title:{defaultValue:null,description:`Заголовок. Строка обрезается троеточием (truncated text) с Tooltip при наведении
...
relative-контейнера. Для потребителей (напр. GridDND рабочих столов),
у которых нет доступа к контенту виджета.`,name:"absolute",required:!1,type:{name:"boolean"}},absoluteOffset:{defaultValue:{value:"12"},description:"Отступ (top/right) при `absolute`.",name:"absoluteOffset",required:!1,type:{name:"number"}}}}}catch{}try{c.Chips.displayName="AnalyticalWidget.Chips",c.Chips.__docgenInfo={description:"",displayName:"AnalyticalWidget.Chips",props:{chips:{defaultValue:null,description:"Пропсы для чипов",name:"chips",required:!0,type:{name:"any[]"}},commonView:{defaultValue:{value:"default"},description:"",name:"commonView",required:!1,type:{name:"enum",value:[{value:'"default"'},{value:'"clear"'},{value:'"accent"'}]}},commonSize:{defaultValue:{value:"xs"},description:"",name:"commonSize",required:!1,type:{name:"enum",value:[{value:'"s"'},{value:'"xs"'},{value:'"m"'}]}},opened:{defaultValue:{value:"false"},description:"",name:"opened",required:!1,type:{name:"boolean"}}}}}catch{}export{c as A,N as T,B as a,G as b,r as c};
