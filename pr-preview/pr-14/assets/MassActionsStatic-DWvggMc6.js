import{d as l}from"./react-D2T61mpp.js";import{y as E,o as d}from"./@salutejs/sdds-themes-DMMPng_c.js";import{H as c}from"./styled-components-aOrnb-IU.js";const a={surfaceSolidCard:()=>E,outlineSolidPrimary:()=>d},p=c.div`
...
- 'relative' - относительное позиционирование`,name:"position",required:!1,type:{name:"enum",value:[{value:'"absolute"'},{value:'"static"'},{value:'"relative"'}]}},show:{defaultValue:null,description:`Явный контроль видимости компонента
