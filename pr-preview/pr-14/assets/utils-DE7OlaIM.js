import{r as o,d as s}from"./react-D2T61mpp.js";import{B as l}from"./Box-aaX20gNQ.js";import{v as r}from"./@salutejs/sdds-themes-DMMPng_c.js";import{hT as n}from"./@salutejs/plasma-icons-CEBC1OsY.js";const v=(i,a)=>({...i,...a}),f={searchedV:"",blocks:[],tribes:[],allocation:"",year:null,filterButton:"",dotsButton:""},m={searchedV:"Поиск",blocks:"Блок",tribes:"Трайб",allocation:"Аллокация",year:"Год",filterButton:"Фильтры",dotsButton:"Меню"},g=(i,a=10)=>o.useMemo(()=>Array(a).fill(0).map((t,e)=>({label:`${m[i]} ${e+1}`,value:e.toString()})),[i,a]);function c(i,a,t){return i.some(e=>"groupId"in e&&e.groupId===a&&(t===void 0?e.items.length>0:e.items.some(u=>u.id===t)))}function h(i,a,t){return a.map(e=>({value:e.value,label:e.label,contentLeft:s.jsxDEV(l,{$css:{visibility:c(t,i,e.value)?"visible":"hidden"},children:s.jsxDEV(n,{size:"s",color:r},void 0,!1,{fileName:"/home/runner/work/dais-ui/dais-ui/packages/storybook/src/stories/AnalyticalWidget/lib/utils.tsx",lineNumber:92,columnNumber:9},this)},void 0,!1,{fileName:"/home/runner/work/dais-ui/dais-ui/packages/storybook/src/stories/AnalyticalWidget/lib/utils.tsx",lineNumber:81,columnNumber:7},this)}))}const x=[{value:"1",label:"1 label"},{value:"2",label:"2 label"}],B=[{value:"1",label:"1 label"},{value:"2",label:"2 label"}],N=[{value:"Удалить",label:"Удалить"},{value:"Some label",label:"Some label"}],A=()=>`Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eligendi
            ...
            nam quos facere, placeat impedit!`;export{f as D,x as a,N as b,B as d,v as f,h as g,A as l,g as u};
