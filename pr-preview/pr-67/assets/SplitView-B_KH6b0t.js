  ...
  * {
  ...
  & .${a.separator} {
    ...
    & .${a.separatorButton} {
      ...
      height: 100%;
      background-color: ${()=>Q};
      border-radius: ${S.spaceX4} 0 0 ${S.spaceX4};
