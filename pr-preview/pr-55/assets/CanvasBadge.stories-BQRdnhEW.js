import{r as b,d as n}from"./react-D2T61mpp.js";import{s as f}from"./storySourceDoc-tVKyHcEN.js";import{C as a,T as p}from"./TableCanvas-NAyE6Iyj.js";const B=["default","accent","positive","warning","negative","dark","light"],k=["xs","s","m","l"],F=B.map(o=>({id:o,view:o})),h={title:"Локальные компоненты/TableCanvas/CanvasElements/CanvasBadge",tags:["!autodocs"]},y=`
