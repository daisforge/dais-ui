import{r as m,d as b}from"./react-D2T61mpp.js";import{c as g}from"./tableData-DVJFoYoT.js";import{cp as p,cw as u}from"./vendor-EFJfASb8.js";import{T as w}from"./TableCanvas-B87eXN3Z.js";import"./react-is-Clcustum.js";import"./styled-components-ClmvW2ML.js";import"./@tanstack/react-virtual-BoqWrlUi.js";import"./tslib-DoU9Jm1N.js";import"./FiltersActions-DRzUhWtK.js";import"./IconButton-Ci_ZEG_9.js";import"./@salutejs/plasma-icons-Qa5Efckp.js";import"./@salutejs/sdds-finai-DXMcdNQs.js";import"./@salutejs/sdds-themes-p9DCXULv.js";import"./utils-C2REGNk8.js";import"./constants-Ci5uyz-N.js";import"./sharedUtilsDebug-BX_KjCjW.js";import"./Box-B_3WwZ-o.js";import"./TextField-BVCMEqrZ.js";import"./sharedUtilsInputs-Yr-_8BUP.js";import"./AnalyticalWidget-B32Hu7_M.js";import"./Collapse-xPCLgoqH.js";import"./Table-CrlruAm3.js";import"./react-data-grid-DDjsodMd.js";import"./TableTabs-BMeBJR_F.js";import"./TableCanvasSharedConstants-B2qJZwC8.js";import"./sharedUiSearch-KW5Gj1J3.js";import"./ListOfFilters-9ja3OMYl.js";import"./lodash.isequal-DD0Lfcik.js";import"./NumberFormat-CAY8CHPL.js";import"./EmptyState-XC7QU3Fa.js";import"./MassActions-llgr_r37.js";import"./Autocomplete-BYQ0MQbi.js";import"./TableGlide-DaXX_-kG.js";import"./@glideappsfinal/glide-data-grid-CN1L2s9C.js";import"./canvas-hypertxt-DsokSIOX.js";import"./ErrorPage-BQvx-2oT.js";const ne={title:"Локальные компоненты/TableCanvas/ContextMenu/Визуальные тесты",tags:["!autodocs"]},C={parameters:{screenshot:{keepState:!0}}};function x(){const[o]=m.useState(g),s=m.useMemo(()=>[{key:"id",name:"ID"},{key:"task",name:"Title"},{key:"priority",name:"Priority"},{key:"issueType",name:"Issue Type"},{key:"developer",name:"Developer"},{key:"tr1",name:"TR"},{key:"complete",name:"% Complete"}],[]);return b.jsxDEV(w,{tableConfig:{onCellContextMenu:(e,t,n)=>{console.debug(e,t,n,"onCellContextMenu")},onCellContextMenuDropdown:{type:"dropdown",getDropdownItems:({column:e})=>[{value:`lvl1 ${e.name}`,label:`${e.name} lvl1`,items:[{value:`lvl1_inside ${e.name}`,label:`${e.name} lvl1 inside`}]},{value:`lvl2 ${e.name}`,label:`${e.name} lvl2`}],onItemSelect:(e,t,n)=>{console.group("onItemSelect for onCellContextMenuDropdown"),console.debug(e,"item"),console.debug(t,"context"),console.debug(n,"event"),console.groupEnd()}},onHeaderContextMenu:(e,t,n)=>console.debug(e,t,n),onHeaderContextMenuDropdown:{type:"dropdown",getDropdownItems:({column:e})=>[{value:`lvl1 ${e.name}`,label:`${e.name} lvl1`,items:[{value:`lvl1_inside ${e.name}`,label:`${e.name} lvl1 inside`}]},{value:`lvl2 ${e.name}`,label:`${e.name} lvl2`}],onItemSelect:(e,t,n)=>{console.group("onItemSelect for onHeaderContextMenuDropdown"),console.debug(e,"item"),console.debug(t,"context"),console.debug(n,"event"),console.groupEnd()}}},columnConfig:s,rows:o},void 0,!1,{fileName:"/home/runner/work/dais-ui/dais-ui/packages/storybook/src/stories/TableCanvas/TableCanvas.ContextMenu/TableCanvasContextMenu.visual.stories.tsx",lineNumber:43,columnNumber:5},this)}const a={name:"Контекстное меню (все возможности)",...C,render:x,play:async({canvasElement:o})=>{const s=await p(()=>{const r=o.querySelector('[data-testid="data-grid-canvas"]');if(!r)throw new Error("Data grid canvas not found");return r});await new Promise(r=>{setTimeout(r,250)});const e=o.ownerDocument,t=o.querySelector(".dvn-scroller")??s,n=t.getBoundingClientRect(),i=n.left+80,l=n.top+20;u.pointerDown(t,{clientX:i,clientY:l,button:2,buttons:2,pointerType:"mouse"}),u.pointerUp(t,{clientX:i,clientY:l,button:2,buttons:0,pointerType:"mouse"}),u.contextMenu(t,{clientX:i,clientY:l,button:2,buttons:2}),await p(()=>{if(!e.querySelector('[data-testid="table-context-menu"]'))throw new Error("Context menu is not open")},{timeout:3e3})}};var c,d,v;a.parameters={...a.parameters,docs:{...(c=a.parameters)==null?void 0:c.docs,source:{originalSource:`{
