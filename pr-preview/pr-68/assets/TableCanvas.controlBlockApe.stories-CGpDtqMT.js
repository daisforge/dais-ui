import{r as u,d as e}from"./react-D2T61mpp.js";import{c as ue}from"./tableData-UCfjiBCh.js";import{s as k}from"./storySourceDoc-tVKyHcEN.js";import{T,S as w}from"./TableCanvas-C7bsey0_.js";import{T as c}from"./TableTabs-ifVf3869.js";import{cO as ie,cP as N}from"./@salutejs/sdds-themes-p9DCXULv.js";import{u as f}from"./starFeature-DmZTgaWm.js";import{qk as g,tX as ce,pg as be,rd as o}from"./@salutejs/plasma-icons-C2i8oSIU.js";const de={title:"Локальные компоненты/TableCanvas/ControlBlock/APE",tags:["!autodocs"]},S=`
...
}`,...(X=(L=m.parameters)==null?void 0:L.docs)==null?void 0:X.source},description:{story:"### 3. XS: Collapsing (above) + ControlBlock (без табов)",...($=(G=m.parameters)==null?void 0:G.docs)==null?void 0:$.description}}};var K,M,_,O,W;C.parameters={...C.parameters,docs:{...(K=C.parameters)==null?void 0:K.docs,source:{originalSource:`{
  ...storySourceDoc({
    preCode,
    previewSource: 'shown'
  }),
...
}`,...(_=(M=C.parameters)==null?void 0:M.docs)==null?void 0:_.source},description:{story:"### 4. XS: ControlBlock inline collapsing",...(W=(O=C.parameters)==null?void 0:O.docs)==null?void 0:W.description}}};var q,H,Y,J,Q;p.parameters={...p.parameters,docs:{...(q=p.parameters)==null?void 0:q.docs,source:{originalSource:`{
  ...storySourceDoc({
    preCode,
    previewSource: 'shown'
  }),
