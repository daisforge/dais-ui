import{r as C,d as e}from"./react-D2T61mpp.js";import{s as u}from"./storySourceDoc-tVKyHcEN.js";import{C as s,T as v}from"./TableCanvas-C7bsey0_.js";const f=["default","accent","secondary","tertiary","paragraph","positive","warning","negative","clear"],g=f.map(a=>({id:a,view:a})),b={title:"Локальные компоненты/TableCanvas/CanvasElements/CanvasLink",tags:["!autodocs"]},k=`
