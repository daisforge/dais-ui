import{d as t,r as d}from"./react-D2T61mpp.js";import{B}from"./Box-_3jV5Wqs.js";import{s as a,c as X}from"./constants-B3b49qmU.js";import{aH as q,x as L,w as M,y as Y,p as O}from"./@salutejs/sdds-themes-DMMPng_c.js";import{H as r}from"./styled-components--DGtfFZ_.js";import{z as T,I as W}from"./@salutejs/sdds-finai-O6aB6XRK.js";import{T as H}from"./AnalyticalWidget-Cemolxg4.js";import{f6 as J,a as K}from"./@salutejs/plasma-icons-Bgg_GZ9Y.js";const c={m:{titleDescriptionGap:a.x2,sectionInnerGap:a.x4,sectionGap:a.x6,contentPaddingY:a.x6,contentPaddingX:"14px"},s:{titleDescriptionGap:a.x1,sectionInnerGap:a.x4,sectionGap:a.x4,contentPaddingY:a.x4,contentPaddingX:"10px"}},f={bg:()=>Y,radius:()=>X.l,titleColor:()=>L,descriptionColor:()=>M,shadow:()=>q},Q=r(T)`
  &.popover-root {
    padding: 0;
    border-radius: 10px;
    box-shadow: ${f.shadow};
