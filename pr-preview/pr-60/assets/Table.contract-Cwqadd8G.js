import{j as r}from"./react-D2T61mpp.js";import{cc as T,cd as w,c6 as R}from"./vendor-BdLrx4xP.js";import{T as E}from"./TableContract-DiBMiaZE.js";const O={title:"Локальные компоненты/Table/Contract",tags:["!autodocs"],parameters:{docs:{page:y},screenshot:{skip:!0}},component:E},i=t=>async({params:e,...M})=>fetch(`${t}${e?`?${e}`:""}`,M).then(P=>P.json()),A=i("api/simple"),F=i("api/searching"),X=i("api/sorting"),$=i("api/pagination"),v=i("api/subRows"),n={args:{fetcher:A}},c={args:{fetcher:$}},s={args:{fetcher:F}},a={args:{fetcher:X}},o={args:{fetcher:v}};var l,h,p;n.parameters={...n.parameters,docs:{...(l=n.parameters)==null?void 0:l.docs,source:{originalSource:`{
  args: {
