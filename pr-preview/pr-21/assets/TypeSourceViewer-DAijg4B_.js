...
> {
  ...
  R extends ObjectForExtending,
  SR = unknown,
> = ColumnConfig<R, SR> | ColumnGroupConfig<R, SR>;`,"packages/ui-kit/src/components/TableCanvas/types/span-config.type.ts$$$SpanColumnConfig":`type SpanColumnConfig = {
  /**
...
};`,"packages/ui-kit/src/components/TableCanvas/types/span-config.type.ts$$$SpanTableConfig":`type SpanTableConfig = {
  /**
...
};`,"packages/ui-kit/src/components/TableCanvas/TableGlideInstance/type.ts$$$ContextMenuDropdownProps":`type ContextMenuDropdownProps = Omit<
  DropdownProps,
  | 'children'
  | 'items'
  | 'placement'
