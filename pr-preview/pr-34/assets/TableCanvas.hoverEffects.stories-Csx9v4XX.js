import{r as n,d as e}from"./react-D2T61mpp.js";import{c as y}from"./tableData-UCfjiBCh.js";import O from"./DocStoryTemplate-3mARu1O0.js";import{s as w}from"./storySourceDoc-tVKyHcEN.js";import{T as S}from"./TableCanvas-COvJEh48.js";import{a1 as l}from"./@salutejs/sdds-finai-BQeC6SeV.js";const x={title:"Локальные компоненты/TableCanvas/HoverEffects",parameters:{docs:{page:O}},tags:["!autodocs"]},H=["row","row-custom-color","disabled"],_={disabled:{},row:{row:!0},"row-custom-color":{row:{color:"#FFF6E5"}}},I=["row","disabled"],M=["range-cell","multi-range-cell","cell","disabled"],A=[{key:"id",name:"ID",width:90},{key:"task",name:"Title",width:260},{key:"priority",name:"Priority",width:180},{key:"issueType",name:"Issue Type",width:180},{key:"complete",name:"% Complete",width:160}],d=o=>o.id+o.issueType,N=`
import {
