import{j as e}from"./react-D2T61mpp.js";import{cg as r,ch as d}from"./vendor-DJU5N2B7.js";import"./react-is-Clcustum.js";import"./styled-components-BNpt5jar.js";import"./@tanstack/react-virtual-BolgHukU.js";import"./tslib-DoU9Jm1N.js";function l(s){const n={a:"a",blockquote:"blockquote",code:"code",h1:"h1",h2:"h2",h3:"h3",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...r(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(d,{title:"Локальные компоненты/TableCanvas/CellsMerging/Справочник"}),`
...
`,e.jsxs(n.p,{children:[`По умолчанию контент блока выравнивается по горизонтали как обычная ячейка
этой колонки — из `,e.jsx(n.code,{children:"contentFormat.alignContent"}),` (у числового формата это правый
