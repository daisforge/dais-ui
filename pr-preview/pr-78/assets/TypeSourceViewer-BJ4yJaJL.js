import{d as c}from"./react-D2T61mpp.js";import{ci as u}from"./vendor-DwzXrIa_.js";const e={"packages/ui-kit/src/components/AiAgentPopover/AiAgentPopover.types.ts$$$AiAgentPopoverProps":`type AiAgentPopoverProps = Omit<
  PopoverProps,
...
> = {
  ...
  | (CanvasNodeTooltipProps & {
    ...
    });`,"packages/ui-kit/src/components/TableCanvas/types/table-config.type.ts$$$BordersConfig":`type BordersConfig<RowType = ObjectForExtending> = {
...
};`,"packages/ui-kit/src/components/TableCanvas/types/table-config.type.ts$$$CellBorderVisibility":`type CellBorderVisibility = {
  top?: boolean;
  right?: boolean;
  bottom?: boolean;
  left?: boolean;
