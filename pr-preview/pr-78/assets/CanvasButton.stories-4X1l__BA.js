import{r as m,d as o}from"./react-D2T61mpp.js";import{s as C}from"./storySourceDoc-tVKyHcEN.js";import{C as r,T as v}from"./TableCanvas-FW3Ia9Wv.js";const g=["default","primary","accent","secondary","clear","success","warning","critical","dark","black","white"],b=["xs","s","m","l"],f=g.map(e=>({id:e,view:e})),p={title:"Локальные компоненты/TableCanvas/CanvasElements/CanvasButton",tags:["!autodocs"]},w=`
