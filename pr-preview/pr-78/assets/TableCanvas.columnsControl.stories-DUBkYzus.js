import{r as e,d as u}from"./react-D2T61mpp.js";import{c}from"./tableData-DVJFoYoT.js";import Nu from"./DocStoryTemplate-C4kDHE18.js";import{s as m}from"./storySourceDoc-tVKyHcEN.js";import{co as Su,cp as V,cw as x,cq as Vu}from"./vendor-DhWFcJyQ.js";import{B}from"./Box-C_yvhQXy.js";import{C as a,T as C}from"./TableCanvas-BaH1qbW4.js";import{v as j}from"./@salutejs/sdds-themes-p9DCXULv.js";import{b as Fu}from"./@salutejs/sdds-finai-BFP0AIhT.js";import{oV as ju,hX as Hu,eQ as H,co as S,e as R,tX as Ru}from"./@salutejs/plasma-icons-DGidcmWm.js";const Pu={title:"Локальные компоненты/TableCanvas/ColumnsControl",tags:["!autodocs"],parameters:{docs:{page:Nu}}},p=`
...
стори проверяет, что новая колонка встаёт на своё место в конфиге, а не в конец.`,...(_=(G=y.parameters)==null?void 0:G.docs)==null?void 0:_.description}}};var q,W,X,K,Q;f.parameters={...f.parameters,docs:{...(q=f.parameters)==null?void 0:q.docs,source:{originalSource:`{
  ...storySourceDoc({
    preCode,
    previewSource: 'shown'
  }),
...
}`,...(X=(W=f.parameters)==null?void 0:W.docs)==null?void 0:X.source},description:{story:`### Динамическое добавление колонки (SimpleTable)
...
клик удаляет её.`,...(Q=(K=f.parameters)==null?void 0:K.docs)==null?void 0:Q.description}}};var J,U,Y,Z,uu;g.parameters={...g.parameters,docs:{...(J=g.parameters)==null?void 0:J.docs,source:{originalSource:`{
  ...storySourceDoc({
    preCode,
    previewSource: 'shown'
  }),
