import{d as c}from"./react-D2T61mpp.js";import{ci as u}from"./vendor-Cn_w75H7.js";const e={"packages/ui-kit/src/components/AiAgentPopover/AiAgentPopover.types.ts$$$AiAgentPopoverProps":`type AiAgentPopoverProps = Omit<
  PopoverProps,
...
> = {
   ...
   */
  domMetadata?: DomMetadata;
};`,"packages/ui-kit/src/components/TableCanvas/types/table-config.type.ts$$$GridLinesConfig":`type GridLinesConfig<RowType = ObjectForExtending> = {
  /** Рисовать ли вертикальные линии между колонками. @default true */
  vertical?: boolean;
  /** Рисовать ли горизонтальные линии между строками тела. @default true */
  horizontal?: boolean;
