import{r as t,d as u}from"./react-D2T61mpp.js";import{c as T}from"./tableData-DVJFoYoT.js";import D from"./DocStoryTemplate-C4kDHE18.js";import{S as B}from"./StoryHint-D7Z2UPWM.js";import{s as w}from"./storySourceDoc-tVKyHcEN.js";import{T as S}from"./TableCanvas-A2e2VF3z.js";import{a2 as l}from"./@salutejs/sdds-finai-BFP0AIhT.js";const F={title:"Локальные компоненты/TableCanvas/HoverEffects",parameters:{docs:{page:D}},tags:["!autodocs"]},x=["row","disabled"],_={disabled:{},row:{row:!0}},I=["row","disabled"],M=["range-cell","multi-range-cell","cell","disabled"],A=[{key:"id",name:"ID",width:90},{key:"task",name:"Title",width:260},{key:"priority",name:"Priority",width:180},{key:"issueType",name:"Issue Type",width:180},{key:"complete",name:"% Complete",width:160}],d=o=>o.id+o.issueType,R=`
import {
