import{r as s,d as e}from"./react-D2T61mpp.js";import{c as y}from"./tableData-DVJFoYoT.js";import H from"./DocStoryTemplate-D1KCoccP.js";import{S as O}from"./StoryHint-D7Z2UPWM.js";import{s as w}from"./storySourceDoc-tVKyHcEN.js";import{T as S}from"./TableCanvas-D12PEhXR.js";import{a2 as l}from"./@salutejs/sdds-finai-CLAU31SQ.js";const x={title:"Локальные компоненты/TableCanvas/HoverEffects",parameters:{docs:{page:H}},tags:["!autodocs"]},_=["row","row-custom-color","disabled"],I={disabled:{},row:{row:!0},"row-custom-color":{row:{color:"#FFF6E5"}}},M=["row","disabled"],R=["range-cell","multi-range-cell","cell","disabled"],A=[{key:"id",name:"ID",width:90},{key:"task",name:"Title",width:260},{key:"priority",name:"Priority",width:180},{key:"issueType",name:"Issue Type",width:180},{key:"complete",name:"% Complete",width:160}],d=o=>o.id+o.issueType,N=`
import {
