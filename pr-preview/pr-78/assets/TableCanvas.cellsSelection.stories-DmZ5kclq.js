import{r as n,d as e}from"./react-D2T61mpp.js";import{c as m}from"./tableData-DVJFoYoT.js";import O from"./DocStoryTemplate-Bt9yziJP.js";import{S as b}from"./StoryHint-D7Z2UPWM.js";import{s as C}from"./storySourceDoc-tVKyHcEN.js";import{T as v}from"./TableCanvas-C83abBVK.js";import{b as k,z as T,a2 as I}from"./@salutejs/sdds-finai-vlgGnyfq.js";import{C as d}from"./@glideappsfinal/glide-data-grid-BkbdCNkn.js";const R={title:"Локальные компоненты/TableCanvas/CellsSelection",tags:["!autodocs"],parameters:{docs:{page:O}}},_=[{label:"range-cell",value:"range-cell"},{label:"multi-range-cell",value:"multi-range-cell"},{label:"cell",value:"cell"},{label:"disabled",value:"disabled"}],N={current:void 0,rows:d.empty(),columns:d.empty()},S=[{key:"id",name:"ID",width:90},{key:"task",name:"Title",width:260},{key:"priority",name:"Priority",width:180},{key:"issueType",name:"Issue Type",width:180},{key:"complete",name:"% Complete",width:160}],E=`
import {
  type ColumnConfig,
  CompactSelection,
  type GridSelection,
