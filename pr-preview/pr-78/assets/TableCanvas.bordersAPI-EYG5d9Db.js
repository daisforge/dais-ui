import{j as e}from"./react-D2T61mpp.js";import{cg as l,ch as o}from"./vendor-DhWFcJyQ.js";import{T as s}from"./TypeSourceViewer-XTdnrnnO.js";import"./react-is-Clcustum.js";import"./styled-components-Cejviklg.js";import"./@tanstack/react-virtual-DeRSQr4k.js";import"./tslib-DoU9Jm1N.js";function i(r){const n={code:"code",h1:"h1",h2:"h2",li:"li",p:"p",pre:"pre",ul:"ul",...l(),...r.components};return e.jsxs(e.Fragment,{children:[e.jsx(o,{title:"Локальные компоненты/TableCanvas/Borders/API"}),`
...
`,e.jsx(n.code,{children:"undefined"}),`, чтобы оставить её. Зовётся на каждую видимую колонку при
перерисовке, поэтому должен быть быстрым.`]}),`
`,e.jsx(n.pre,{children:e.jsx(n.code,{className:"language-tsx",children:`borders={{
  getVerticalBorder: ({ columnKey }) =>
    columnKey === 'priority' ? false : undefined,
}}
`})})]})}function p(r={}){const{wrapper:n}={...l(),...r.components};return n?e.jsx(n,{...r,children:e.jsx(i,{...r})}):i(r)}export{p as default};
