...
`})}),`
`,e.jsxs(n.p,{children:[`Fill handle проходит ту же цепочку начиная с шага 6 (без clipboard и без
...
`,e.jsx(c,{})]})}function J(l={}){const{wrapper:n}={...s(),...l.components};return n?e.jsx(n,{...l,children:e.jsx(r,{...l})}):r(l)}export{J as default};
