import{r as o,d as t,j as n}from"./react-D2T61mpp.js";import{cn as m,cg as l,ch as p}from"./vendor-BQJg2Bc2.js";import{C as g}from"./CopyButton-BvlSj8-t.js";import{B as _}from"./Box-BsiCI7Vx.js";import{a as v}from"./TextField-Dd4XdJYW.js";import{u as C}from"./utils-CZEILeU8.js";import{g as h}from"./generateId-BYGzgL1y.js";import{G as T}from"./styles-C1OWeWxT.js";import"./react-is-Clcustum.js";import"./styled-components-CFcez-o8.js";import"./@tanstack/react-virtual-gmWiB3nU.js";import"./tslib-DoU9Jm1N.js";import"./sharedUtilsCopy-CJCD6cY9.js";import"./sharedUtilsDebug-BX_KjCjW.js";import"./@salutejs/sdds-finai-elLnKBVN.js";import"./@salutejs/sdds-themes-p9DCXULv.js";import"./@salutejs/plasma-icons-G6-ZG7jG.js";import"./sharedUtilsInputs-uQetm5GV.js";import"./constants-Ci5uyz-N.js";import"./mixins-DWr8aiuK.js";import"./@salutejs/plasma-typo-9StxXtYu.js";import"./EXTERNAL_PACKAGE_MODULE_sdds_finai_high_contrast__light_theme-uTSVIbRM.js";import"./@salutejs-ds/sdds_finai_high_contrast-DoAS7YWi.js";import"./@salutejs-ds/sdds_finai_beta_core-CRX1TY7Q.js";const F=`# Change Log
...
`;function y(d,i){const a=i.replace(/[.*+?^${}()|[\]\\]/g,"\\$&"),e=new RegExp(`(${a})`,"gi");return d.replace(e,"<mark>$1</mark>")}const u="service:";function x(d,i){const a=i.trim();if(!a||a.length<2)return[{id:`${u}all changelog`,content:d}];const e=k(d).slice(1),s=i.toLowerCase(),c=e.filter(f=>f.content.toLowerCase().includes(s));return c.length===0?[{id:`${u}not found`,content:`Ничего не найдено по запросу **«${i}»** .`}]:c.map(f=>({id:f.id,content:y(f.content,i)}))}function k(d){const i=d.split(`
...
`)}),a}const w=d=>d.replace(/https?:\/\/stash\.delta\.dddd\.ru:7999\/([^/]+)\/([^/]+)\/compare\/v([^)]+)\.\.\.v([^)]+)\)/g,"https://stash.dddddd.ru/projects/$1/repos/$2/compare/diff?sourceBranch=refs%2Ftags%2Fv$4&targetRepoId=160675&targetBranch=refs%2Ftags%2Fv$3"),B=d=>d.replace(/stash.dddddd.ru:7999\/uvhd-fiori/g,"stash.dddddd.ru/projects/UVHD-FIORI/repos"),S=d=>B(w(d)),A=({changelog:d})=>{const i=o.useMemo(()=>S(d),[d]),[a,e]=o.useState(""),s=C(a,700),c=o.useMemo(()=>x(i,s),[i,s]);return t.jsxDEV("div",{children:[t.jsxDEV(T,{},void 0,!1,{fileName:"/home/runner/work/dais-ui/dais-ui/packages/storybook/src/stories/Changelog/ChangelogSearch.tsx",lineNumber:63,columnNumber:7},void 0),t.jsxDEV("div",{style:{marginBottom:"16px",maxWidth:"400px"},children:t.jsxDEV(v,{value:a,onChange:r=>e(r.target.value),onClear:()=>e(""),placeholder:"Поиск",size:"s"},void 0,!1,{fileName:"/home/runner/work/dais-ui/dais-ui/packages/storybook/src/stories/Changelog/ChangelogSearch.tsx",lineNumber:65,columnNumber:9},void 0)},void 0,!1,{fileName:"/home/runner/work/dais-ui/dais-ui/packages/storybook/src/stories/Changelog/ChangelogSearch.tsx",lineNumber:64,columnNumber:7},void 0),t.jsxDEV("style",{children:`
...
`,n.jsx(A,{changelog:F})]})}function id(d={}){const{wrapper:i}={...l(),...d.components};return i?n.jsx(i,{...d,children:n.jsx(b,{...d})}):b()}export{id as default};
