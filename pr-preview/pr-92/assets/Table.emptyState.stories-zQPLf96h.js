import{d,r as c}from"./react-D2T61mpp.js";import{s as g}from"./storySourceDoc-tVKyHcEN.js";import{T as C}from"./TableCanvas-CzBP2Nte.js";const p=700,M=1200,y=[],t=[{key:"id",name:"ID"},{key:"name",name:"Сотрудник"},{key:"status",name:"Статус"},{key:"team",name:"Команда"}],L=[{key:"employee-group",name:"Сотрудник",children:[{key:"id",name:"ID"},{key:"name",name:"ФИО"}]},{key:"meta-group",name:"Статус и команда",children:[{key:"status",name:"Статус"},{key:"team",name:"Команда"}]}],w=[];function S(e,u){const[n,o]=c.useState(!0),[v,E]=c.useState(e);return c.useEffect(()=>{o(!0),E(e);const k=setTimeout(()=>{E(u),o(!1)},M);return()=>{clearTimeout(k)}},[u,e]),{columnConfig:v,isLoading:n}}const Y={title:"Локальные компоненты/TableCanvas/EmptyState",tags:["!autodocs"],parameters:{docs:{description:{component:"Все demo-сценарии специально проходят через loading, чтобы в Storybook не было промежуточного broken-image кадра у EmptyState."}}}},f=`
