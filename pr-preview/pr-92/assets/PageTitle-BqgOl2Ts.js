import{r as y,d as e}from"./react-D2T61mpp.js";import{T as f}from"./AnalyticalWidget-CT_uYCgE.js";import{w as v}from"./@salutejs/sdds-themes-p9DCXULv.js";import{a as n,f as S,d as w}from"./utils-CZEILeU8.js";import{s as o}from"./constants-Ci5uyz-N.js";import{H as l,C as g}from"./styled-components-CFcez-o8.js";import{a4 as V,I as $}from"./@salutejs/sdds-finai-elLnKBVN.js";import{eZ as j}from"./@salutejs/plasma-icons-G6-ZG7jG.js";const a="PageTitle__",t={root:`${a}root`,breadcrumbs:`${a}breadcrumbs`,content:`${a}content`,leftBlock:`${a}left-block`,titleBlock:`${a}title-block`,title:`${a}title`,subtitle:`${a}subtitle`,titleSlot:`${a}title-slot`,rightBlock:`${a}right-block`,backIconButton:`${a}back-icon-block`},q=l.div.attrs({className:t.root})`
  width: 100%;
  display: flex;
...
По умолчанию size='m'`,name:"breadcrumbs",required:!1,type:{name:"BreadcrumbsPropsComp"}},$css:{defaultValue:null,description:"Кастомные стили styled-components для основного контейнера",name:"$css",required:!1,type:{name:"string | CSSObject | FlattenSimpleInterpolation"}},showBackButton:{defaultValue:null,description:"Показывать ли кнопку со стрелкой назад слева от title",name:"showBackButton",required:!1,type:{name:"boolean"}},onBackClick:{defaultValue:null,description:"Callback при клике на кнопку назад",name:"onBackClick",required:!1,type:{name:"() => void"}}}}}catch{}export{r as P};
