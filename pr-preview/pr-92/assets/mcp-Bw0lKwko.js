import{j as e}from"./react-D2T61mpp.js";import{cg as d,ch as r,ci as i}from"./vendor-BQJg2Bc2.js";import"./react-is-Clcustum.js";import"./styled-components-CFcez-o8.js";import"./@tanstack/react-virtual-gmWiB3nU.js";import"./tslib-DoU9Jm1N.js";function c(n){const s={code:"code",h1:"h1",li:"li",p:"p",strong:"strong",ul:"ul",...d(),...n.components};return e.jsxs(e.Fragment,{children:[e.jsx(r,{title:"Как работать с MCP"}),`
...
`,e.jsx("div",{className:"sb-container",children:e.jsxs("div",{className:"sb-section-title",children:[e.jsx(s.h1,{id:"какие-инструменты-доступны-агенту",children:"Какие инструменты доступны агенту"}),e.jsx(s.p,{children:"После подключения MCP-сервер отдаёт агенту одиннадцать инструментов:"}),e.jsxs(s.ul,{children:[`
...
`,e.jsxs(s.li,{children:[e.jsx(s.code,{children:"list_categories"})," — категории каталога с количеством компонентов по типам. Аргументов не принимает."]}),`
`,e.jsxs(s.li,{children:[e.jsx(s.code,{children:"get_installation_guide"})," — установка пакета, подключение стилей и токенов, использование компонентов и иконок. Аргументов не принимает."]}),`
`]})]})}),`
...
`,e.jsx("style",{children:`
  ...
  `})]})}function h(n={}){const{wrapper:s}={...d(),...n.components};return s?e.jsx(s,{...n,children:e.jsx(c,{...n})}):c(n)}export{h as default};
