import{r as d,d as u}from"./react-D2T61mpp.js";import ee from"./DocStoryTemplate-DFXuHZSX.js";import{S as p}from"./StoryHint-D7Z2UPWM.js";import{s as E}from"./storySourceDoc-tVKyHcEN.js";import{T as w,C}from"./TableCanvas-CNTnXOQI.js";import{b,a2 as T}from"./@salutejs/sdds-finai-C-BS5BDf.js";const ue={title:"Локальные компоненты/TableCanvas/CellsMerging",tags:["!autodocs"],parameters:{docs:{page:ee}}},ne=[{label:"cell",value:"cell"},{label:"range-cell",value:"range-cell"},{label:"multi-range-cell",value:"multi-range-cell"},{label:"disabled",value:"disabled"}],te=[{label:"row",value:"row"},{label:"disabled",value:"disabled"}],oe=`
