import{r as o,d as r}from"./react-D2T61mpp.js";import{c}from"./tableData-UCfjiBCh.js";import X from"./DocStoryTemplate-DiJAdvEC.js";import{g as Z}from"./getFuncAsString-C1kndaLg.js";import{s as m}from"./storySourceDoc-tVKyHcEN.js";import{E as J}from"./EmptyState-C5WIHYMF.js";import{f as d}from"./Table-CglBQ-O2.js";import{a7 as Q}from"./@salutejs/sdds-finai-IZHEqlfF.js";import{bq as U}from"./vendor-B9_16pJt.js";const Y={title:"Локальные компоненты/Table/ContextMenu",tags:["!autodocs"],parameters:{docs:{page:X}}},k=`
...
${Z("packages/storybook/src/stories/Table/Table.contextMenu/Table.contextMenu.stories.tsx","AsyncCellDropdownExample")}`,v={name:"Async-подгрузка пунктов (успех)",...m({previewSource:"hidden",code:q}),render:()=>r.jsxDEV(W,{shouldFail:!1},void 0,!1,{fileName:"/home/runner/work/dais-ui/dais-ui/packages/storybook/src/stories/Table/Table.contextMenu/Table.contextMenu.stories.tsx",lineNumber:598,columnNumber:17},void 0)},w={name:"Async-подгрузка пунктов (ошибка + ретрай)",...m({previewSource:"hidden",code:q}),render:()=>r.jsxDEV(W,{shouldFail:!0},void 0,!1,{fileName:"/home/runner/work/dais-ui/dais-ui/packages/storybook/src/stories/Table/Table.contextMenu/Table.contextMenu.stories.tsx",lineNumber:607,columnNumber:17},void 0)};var f,T,M;y.parameters={...y.parameters,docs:{...(f=y.parameters)==null?void 0:f.docs,source:{originalSource:`{
  ...storySourceDoc({
    preCode,
    previewSource: 'shown'
  }),
