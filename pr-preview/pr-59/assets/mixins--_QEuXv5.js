...
`,Y=({width:r,height:o,borderRadius:t,isThin:e,thumbColor:a,thumbColorHover:i,trackColor:n,trackColorHover:l,theme:b}={})=>{const d=K({thumbColor:a,thumbColorHover:i,trackColor:n,trackColorHover:l,theme:b});return M({width:r,height:o,borderRadius:t,isThin:e,...d})},P=w`
  0%,
  100% {
    box-shadow:
...
`,j=({backgroundColor:r="transparent",borderColor:o="var(--on-light-outline-accent-minor, rgb(82, 186, 255))",borderColorFade:t="rgba(82, 186, 255, 0.42)",shadowColor:e="rgba(82, 186, 255, 0.24)",shadowColorFade:a="rgba(82, 186, 255, 0)",inset:i="-4px",borderRadius:n="16px",duration:l="1.4s",timingFunction:b="ease-in-out",iterationCount:d="infinite",pointerEventsNone:v=!0}={})=>s`
  ...
  `;export{m as B,k as a,O as b,X as c,Y as g,j as t};
