import{r as e,d as u}from"./react-D2T61mpp.js";import{c as m}from"./tableData-UCfjiBCh.js";import z from"./DocStoryTemplate-DgnSsvAh.js";import{s as b}from"./storySourceDoc-tVKyHcEN.js";import{T as C}from"./TableCanvas-gKY-SjsO.js";import{b as f,z as p,a2 as $}from"./@salutejs/sdds-finai-Dy07Vhqq.js";import{C as d}from"./@glideappsfinal/glide-data-grid-CgYhCgLY.js";const U={title:"Локальные компоненты/TableCanvas/CellsSelection",tags:["!autodocs"],parameters:{docs:{page:z}}},W=[{label:"range-cell",value:"range-cell"},{label:"multi-range-cell",value:"multi-range-cell"},{label:"cell",value:"cell"},{label:"disabled",value:"disabled"}],k={current:void 0,rows:d.empty(),columns:d.empty()},S=[{key:"id",name:"ID",width:90},{key:"task",name:"Title",width:260},{key:"priority",name:"Priority",width:180},{key:"issueType",name:"Issue Type",width:180},{key:"complete",name:"% Complete",width:160}],v=`
import {
  type ColumnConfig,
  CompactSelection,
  type GridSelection,
