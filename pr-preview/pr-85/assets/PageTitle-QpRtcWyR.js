import{r as y,d as e}from"./react-D2T61mpp.js";import{T as f}from"./AnalyticalWidget-b-9gE6Zc.js";import{w as v}from"./@salutejs/sdds-themes-p9DCXULv.js";import{a as n,f as S,d as w}from"./utils-CZFPcdcE.js";import{s as o}from"./constants-Ci5uyz-N.js";import{H as l,C as g}from"./styled-components-KwnbZyt5.js";import{a4 as V,I as $}from"./@salutejs/sdds-finai-33CWxLUw.js";import{eZ as j}from"./@salutejs/plasma-icons-DWS_8Hv6.js";const a="PageTitle__",t={root:`${a}root`,breadcrumbs:`${a}breadcrumbs`,content:`${a}content`,leftBlock:`${a}left-block`,titleBlock:`${a}title-block`,title:`${a}title`,subtitle:`${a}subtitle`,titleSlot:`${a}title-slot`,rightBlock:`${a}right-block`,backIconButton:`${a}back-icon-block`},q=l.div.attrs({className:t.root})`
  width: 100%;
  display: flex;
...
Это временный escape hatch, не основной сценарий использования.`,name:"disableMediaAdaptive",required:!1,type:{name:"boolean"}},$css:{defaultValue:null,description:"Кастомные стили styled-components для основного контейнера",name:"$css",required:!1,type:{name:"string | CSSObject | FlattenSimpleInterpolation"}},showBackButton:{defaultValue:null,description:"Показывать ли кнопку со стрелкой назад слева от title",name:"showBackButton",required:!1,type:{name:"boolean"}},onBackClick:{defaultValue:null,description:"Callback при клике на кнопку назад",name:"onBackClick",required:!1,type:{name:"() => void"}},subtitle:{defaultValue:null,description:"Подзаголовок/описание страницы (текст)",name:"subtitle",required:!1,type:{name:"string"}},titleTypographyProps:{defaultValue:null,description:"Пропсы для TypographyWithAutoTooltip в который обернут title",name:"titleTypographyProps",required:!1,type:{name:'Omit<TypographyWithAutoTooltipProps<"H2">, "children" | "variant">'}},subtitleTypographyProps:{defaultValue:null,description:"Пропсы для  TypographyWithAutoTooltip в который обернут subtitle",name:"subtitleTypographyProps",required:!1,type:{name:'Omit<TypographyWithAutoTooltipProps<"BodyS">, "children" | "variant">'}},titleSlot:{defaultValue:null,description:`Кастомный слот правее заголовка.
