import{r as t,d as e}from"./react-D2T61mpp.js";import{a as Y,B as F,P as X,T as Z,c as T}from"./tableData-DVJFoYoT.js";import ee from"./DocStoryTemplate-CW0G7jtC.js";import{S as C}from"./StoryHint-D7Z2UPWM.js";import{s as p}from"./storySourceDoc-tVKyHcEN.js";import{C as c,T as b}from"./TableCanvas-BsBs2Pi-.js";import{a2 as D}from"./@salutejs/sdds-finai-CE284srQ.js";const ne={title:"Локальные компоненты/TableCanvas/Copy-Paste-Fill",tags:["!autodocs"],parameters:{docs:{page:ee}}},oe=[{label:"row",value:"row"},{label:"disabled",value:"disabled"}],ue=[{label:"cell",value:"cell"},{label:"range-cell",value:"range-cell"},{label:"multi-range-cell",value:"multi-range-cell"},{label:"disabled",value:"disabled"}],N="import { ColumnConfig, TableCanvas } from '@daisforge/ui/components/TableCanvas';",h=`const rows = [
