import{r as t,d as e}from"./react-D2T61mpp.js";import{c as te}from"./tableData-UCfjiBCh.js";import{s as p}from"./storySourceDoc-tVKyHcEN.js";import{T as f,S as B}from"./TableCanvas-BSMBdin1.js";import{T as c}from"./TableTabs-8t3XoJZS.js";import{cO as ie,cP as E}from"./@salutejs/sdds-themes-p9DCXULv.js";import{u as T}from"./starFeature-Qm8DOhFg.js";import{qk as S,tX as ce,pg as be,rd as o}from"./@salutejs/plasma-icons-DXylCXcG.js";const de={title:"Локальные компоненты/TableCanvas/ControlBlock",tags:["!autodocs"]},g=`
...
TableTabs с кастомным слотом справа, без коллапсинга.`,...(R=(j=d.parameters)==null?void 0:j.docs)==null?void 0:R.description}}};var P,L,G,$,M;m.parameters={...m.parameters,docs:{...(P=m.parameters)==null?void 0:P.docs,source:{originalSource:`{
  ...storySourceDoc({
    preCode,
    previewSource: 'shown'
  }),
...
Коллапсинг с rightSlot над таблицей, без TableTabs.`,...(M=($=m.parameters)==null?void 0:$.docs)==null?void 0:M.description}}};var K,_,O,W,q;C.parameters={...C.parameters,docs:{...(K=C.parameters)==null?void 0:K.docs,source:{originalSource:`{
  ...storySourceDoc({
    preCode,
    previewSource: 'shown'
  }),
...
}`,...(O=(_=C.parameters)==null?void 0:_.docs)==null?void 0:O.source},description:{story:`### 4. ControlBlock inline collapsing (без табов, без above)

Коллапсинг inline — кнопка внутри controlBlock.`,...(q=(W=C.parameters)==null?void 0:W.docs)==null?void 0:q.description}}};var H,X,Y,J,Q;v.parameters={...v.parameters,docs:{...(H=v.parameters)==null?void 0:H.docs,source:{originalSource:`{
  ...storySourceDoc({
    preCode,
    previewSource: 'shown'
  }),
...
}`,...(Y=(X=v.parameters)==null?void 0:X.docs)==null?void 0:Y.source},description:{story:"### 5. Title above (через collapsing API, без коллапсинга)\n\nЗаголовок таблицы через `collapsing.titleText` + `collapseButtonPlacement: 'above'`, без enableCollapse.",...(Q=(J=v.parameters)==null?void 0:J.docs)==null?void 0:Q.description}}};var U,Z,ee,ne,oe;k.parameters={...k.parameters,docs:{...(U=k.parameters)==null?void 0:U.docs,source:{originalSource:`{
  ...storySourceDoc({
    preCode,
    previewSource: 'shown'
  }),
