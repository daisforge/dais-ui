import{j as e}from"./react-D2T61mpp.js";import{cg as i,ch as c}from"./vendor-nNOZyNLP.js";import{T as l}from"./TypeSourceViewer-Br8prlO8.js";import"./react-is-Clcustum.js";import"./styled-components-Bm5ATt6S.js";import"./@tanstack/react-virtual-CKihwRsW.js";import"./tslib-DoU9Jm1N.js";function s(o){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",ol:"ol",p:"p",pre:"pre",strong:"strong",ul:"ul",...i(),...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(c,{title:"Локальные компоненты/TableCanvas/Tooltip/API"}),`
...
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"tooltip.minWidth"})," — глобальная минимальная ширина тултипа (число = px, строка с единицей отдаётся как есть). Действует на все canvas-тултипы, включая авто-тултип ",e.jsx(n.code,{children:"Canvas.Text"}),". Per-node переопределяет."]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.strong,{children:"tooltip.maxWidth"})," — глобальная максимальная ширина тултипа (число = px, строка с единицей отдаётся как есть). Действует на все canvas-тултипы, включая авто-тултип ",e.jsx(n.code,{children:"Canvas.Text"}),". Per-node переопределяет."]}),`
`]}),`
...
`,e.jsx(l,{language:"ts",filePath:"packages/ui-kit/src/components/TableGlide/lib/canvas/utils/portalHoverEvents.ts",typeName:"CanvasPortalHoverDetail"})]})}function p(o={}){const{wrapper:n}={...i(),...o.components};return n?e.jsx(n,{...o,children:e.jsx(s,{...o})}):s(o)}export{p as default};
