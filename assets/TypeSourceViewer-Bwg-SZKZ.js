import{d}from"./react-D2T61mpp.js";import{c4 as u}from"./vendor-CiLFOTMj.js";const e={"packages/ui-kit/src/components/AiAgentPopover/AiAgentPopover.types.ts$$$AiAgentPopoverProps":`type AiAgentPopoverProps = Omit<
  PopoverProps,
...
> = Omit<PreviewCellInfoGlideInstance<R, SR, CustomCtxs>, 'column'> & {
  ...
  disabled?: boolean;
};`,"packages/ui-kit/src/components/TableCanvas/types/column-config.type.ts$$$ColumnGroupConfig":`type ColumnGroupConfig<R extends ObjectForExtending, SR> = ColumnGroup<
//     R,
//     SR
