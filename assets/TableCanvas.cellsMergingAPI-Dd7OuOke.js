import{j as e}from"./react-D2T61mpp.js";import{cc as i,cd as g}from"./vendor-CSAr92if.js";import{T as l}from"./TypeSourceViewer-BYeJU5_Z.js";import"./react-is-Clcustum.js";import"./styled-components-ZBTAG_Yl.js";import"./@tanstack/react-virtual-B8iA4ZKy.js";import"./tslib-De9GV7Vy.js";function r(s){const n={code:"code",h1:"h1",h2:"h2",p:"p",pre:"pre",...i(),...s.components};return e.jsxs(e.Fragment,{children:[e.jsx(g,{title:"Локальные компоненты/TableCanvas/CellsMerging/API"}),`
...
`,e.jsx(l,{language:"ts",filePath:"packages/ui-kit/src/components/TableCanvas/feature-tree/types.ts",typeName:"SubRows"})]})}function h(s={}){const{wrapper:n}={...i(),...s.components};return n?e.jsx(n,{...s,children:e.jsx(r,{...s})}):r(s)}export{h as default};
