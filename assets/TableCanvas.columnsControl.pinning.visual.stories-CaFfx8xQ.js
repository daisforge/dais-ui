...
}`,...(U=(R=p.parameters)==null?void 0:R.docs)==null?void 0:U.source},description:{story:"3. Один столбец → закрепить кликом по ЛЕВОЙ иконке (не через дропдаун).",...(q=(L=p.parameters)==null?void 0:L.docs)==null?void 0:q.description}}};var K,j,_,Y,$;m.parameters={...m.parameters,docs:{...(K=m.parameters)==null?void 0:K.docs,source:{originalSource:`{
...
}`,...(_=(j=m.parameters)==null?void 0:j.docs)==null?void 0:_.source},description:{story:"4. Диапазон столбцов (Shift) → «Закрепить столбцы»; выделение сохраняется.",...($=(Y=m.parameters)==null?void 0:Y.docs)==null?void 0:$.description}}};var z,W,X,H,J;E.parameters={...E.parameters,docs:{...(z=E.parameters)==null?void 0:z.docs,source:{originalSource:`{
