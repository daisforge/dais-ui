import{r as v,d as n}from"./react-D2T61mpp.js";import{s as f}from"./storySourceDoc-tVKyHcEN.js";import{C as t,T as b}from"./TableCanvas-D3ah3p7W.js";const h=[{id:1},{id:2},{id:3}],x=["row","column"],y=["flex-start","center","flex-end","stretch"],w=["flex-start","center","flex-end","space-between"],T={title:"Локальные компоненты/TableCanvas/CanvasElements/CanvasContainer",tags:["!autodocs"]},k=`
