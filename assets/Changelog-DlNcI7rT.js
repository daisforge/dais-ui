...
- **table-canvas:** keep merged select-cell chevron one row tall ([0ddd2d7](https://github.com/daisforge/dais-ui/commit/0ddd2d72585ac1ff7f937ac2104882b1cb8b1908))
- **table-canvas:** объявляем spanAlign на ColumnConfigInternal ([ac34718](https://github.com/daisforge/dais-ui/commit/ac34718a050e4cc9b2eb15cd3df2bd3639f9f4be))
- **table-canvas:** типизация тестов под noPropertyAccessFromIndexSignature ([d79bb58](https://github.com/daisforge/dais-ui/commit/d79bb58178f188648ec68b1b4251e255d0885f9f))
- **table-canvas:** чиним разрешение мержа develop и замечания линтера ([0cdcea6](https://github.com/daisforge/dais-ui/commit/0cdcea62937b7380a81483a0a353894f123b2ccd))
- **TableCanvas:** center summary checkbox in the last header level for grouped headers ([47a8976](https://github.com/daisforge/dais-ui/commit/47a897654f315f890e6fc34176c0ce8cebf09727))
- **TableCanvas:** drop stale identifier from useColumns deps after merged view dedup ([ee47a7c](https://github.com/daisforge/dais-ui/commit/ee47a7c0dcf680563948954814c137a14f9f3042))
- **TableCanvas:** expand selection to merged blocks outside edit mode ([456de40](https://github.com/daisforge/dais-ui/commit/456de40a9f55165d9387065b0babbbc57f91a78b))
- **TableCanvas:** resolve column by glide order for pinned columns ([c151c4f](https://github.com/daisforge/dais-ui/commit/c151c4f21019ebcfcd6383586b8b70c3a94b5747))
- **TableCanvas:** resolve merged regions against frozen-first column order ([2b9dc38](https://github.com/daisforge/dais-ui/commit/2b9dc381f508391b045c0fff8295ecfa7e9a3999))
- **TableGlide:** colSpan <= 0 yields no span so single-column merges render ([73350c7](https://github.com/daisforge/dais-ui/commit/73350c7082b24bc39ca28def318769683b369749))
...
- **table-canvas:** mergedCellsAlign колонки функцией по данным строки ([b9ec154](https://github.com/daisforge/dais-ui/commit/b9ec1543133e43ecfdd704c7bb3b65486201a0e1))
- **table-canvas:** виртуализация списка колонок в правом сайдбаре. Оптимизирована производительность выделения, редактирования и открытия сайдбара на больших данных ([ba6fd03](https://github.com/daisforge/dais-ui/commit/ba6fd0355f7a46106c1f10d34e1a26e34a601ed3))
- **table-canvas:** выравниваем триггер редактируемого select по блоку ([5e46e03](https://github.com/daisforge/dais-ui/commit/5e46e03e706540a2399b4d0859c91c4e45ce2808))
- **table-canvas:** переходим на @glideappsfinal/glide-data-grid 6.2.0 ([bad2d68](https://github.com/daisforge/dais-ui/commit/bad2d684e1bb60f3afdbefdd02685f15c255c7c8))
- **table-canvas:** пробрасываем mergedCellsAlign в грид через адаптер ([09471a0](https://github.com/daisforge/dais-ui/commit/09471a0989a614ca4d6dec32dc3baf190cb73501))
- **TableCanvas:** controlled merge list (spanCells.spans) with external state ([8dcbbaf](https://github.com/daisforge/dais-ui/commit/8dcbbaf22ae4268fa7287002b1dc43b4df5a6bbc))
- **TableCanvas:** editor writes merged block as a whole ([3c1cd16](https://github.com/daisforge/dais-ui/commit/3c1cd1632d76562ce9fac514aff5d6e2cf70ac8a))
- **TableCanvas:** merge body cells (rowspan + rectangular) with origin resolution ([069d8f6](https://github.com/daisforge/dais-ui/commit/069d8f69444c19660c3649933b41aba29e76cc4b))
- **TableCanvas:** merge-aware copy/paste/fill for body cells ([eeb84c3](https://github.com/daisforge/dais-ui/commit/eeb84c3af09e298116772a9fd402bb4a76f22a76))
- **TableCanvas:** mergedCellsAlign for content alignment in merged cells ([1263f4b](https://github.com/daisforge/dais-ui/commit/1263f4b5baaa3dbc5ed69e6731ba9cfa62bf3602))
- **TableCanvas:** optional disableGroupColumnsSort for merged grouping ([384b93c](https://github.com/daisforge/dais-ui/commit/384b93cf27a341987ae297e52802f2c57fd45c41))
- **TableCanvas:** rowsGrouping view=merged renders groups as merged cells ([06c630e](https://github.com/daisforge/dais-ui/commit/06c630e048bb520e47b58e82f93210fe11996652))
- **TableCanvas:** subRows merged view - flatten tree into leaves with merged ancestor columns ([763a6fc](https://github.com/daisforge/dais-ui/commit/763a6fc0acd5221d60f8f9883b8abb43690ecd33))
- **TableCanvas:** tableConfig.spanCells.spanBy — merge body cells by value ([fd2daae](https://github.com/daisforge/dais-ui/commit/fd2daaef31f70ec05ef685a9a36af7549b1b7d32))
