import{j as e}from"./react-D2T61mpp.js";import{cc as r,cd as l}from"./vendor-B2v8DMVc.js";import{T as n}from"./TypeSourceViewer-U-TUpajx.js";import{g as s}from"./getTypeAsString-Dm-basyW.js";import"./react-is-Clcustum.js";import"./styled-components-Dg4_4Hb_.js";import"./@tanstack/react-virtual-D_A8jBfn.js";import"./tslib-De9GV7Vy.js";function c(t){const o={code:"code",h1:"h1",h2:"h2",p:"p",pre:"pre",...r(),...t.components};return e.jsxs(e.Fragment,{children:[e.jsx(l,{title:"Локальные компоненты/TableCanvas/ControlBlock/API"}),`
`,e.jsx(o.h1,{id:"controlblock-api",children:"ControlBlock API"}),`
`,e.jsx(o.h2,{id:"controlblockconfig",children:"ControlBlockConfig"}),`
`,e.jsx(n,{filePath:"packages/ui-kit/src/components/TableCanvas/types/table-config.type.ts",typeName:"ControlBlockConfig",language:"ts"}),`
...
`})}),`
`,e.jsx(n,{filePath:"packages/ui-kit/src/components/TableCanvas/widgets/control-block/control-block-button.types.tsx",typeName:"ButtonProps",language:"ts",postSource:`
...
`,e.jsx(n,{filePath:"packages/ui-kit/src/components/TableCanvas/widgets/control-block/types.ts",typeName:"FeatureItem",language:"ts"}),`
...
`,e.jsx(n,{filePath:"packages/ui-kit/src/components/TableCanvas/widgets/control-block/types.ts",typeName:"FeatureDetails",language:"ts"}),`
...
`,e.jsx(n,{filePath:"packages/ui-kit/src/components/TableCanvas/widgets/control-block/types.ts",typeName:"FeatureIconRender",language:"ts"}),`
...
`,e.jsx(n,{filePath:"packages/ui-kit/src/components/TableCanvas/widgets/control-block/types.ts",typeName:"DropdownRenderCtx",language:"ts"})]})}function m(t={}){const{wrapper:o}={...r(),...t.components};return o?e.jsx(o,{...t,children:e.jsx(c,{...t})}):c(t)}export{m as default};
