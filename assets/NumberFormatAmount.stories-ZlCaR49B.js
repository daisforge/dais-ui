import{r as m,d as u}from"./react-D2T61mpp.js";import{s as v}from"./storySourceDoc-tVKyHcEN.js";import{N as a}from"./NumberFormatAmount-Biw8wIYp.js";import{rd as b}from"./@salutejs/plasma-icons-D_Q3trqb.js";const O={title:"Локальные компоненты/NumberFormatAmount",component:a,parameters:{docs:{toc:!0}},tags:["!autodocs"],args:{size:"s",placeholder:"Сумма",disabled:!1,readOnly:!1,thousandSeparator:" ",decimalSeparator:".",decimalScale:2},argTypes:{size:{options:["s","xs"],control:{type:"select"}},disabled:{control:{type:"boolean"}},readOnly:{control:{type:"boolean"}}}},h=`
