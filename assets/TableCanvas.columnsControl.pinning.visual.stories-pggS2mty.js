...
}`,...(v=(b=l.parameters)==null?void 0:b.docs)==null?void 0:v.source},description:{story:"1. Меню открывается и содержит оба нативных пункта (функционально, без скрина).",...(P=(S=l.parameters)==null?void 0:S.docs)==null?void 0:P.description}}};var I,G,M,V,N;p.parameters={...p.parameters,docs:{...(I=p.parameters)==null?void 0:I.docs,source:{originalSource:`{
...
}`,...(M=(G=p.parameters)==null?void 0:G.docs)==null?void 0:M.source},description:{story:"2. Один столбец → «Закрепить столбцы» через дропдаун.",...(N=(V=p.parameters)==null?void 0:V.docs)==null?void 0:N.description}}};var O,R,U,q,L;d.parameters={...d.parameters,docs:{...(O=d.parameters)==null?void 0:O.docs,source:{originalSource:`{
...
}`,...(U=(R=d.parameters)==null?void 0:R.docs)==null?void 0:U.source},description:{story:"3. Один столбец → закрепить кликом по ЛЕВОЙ иконке (не через дропдаун).",...(L=(q=d.parameters)==null?void 0:q.docs)==null?void 0:L.description}}};var K,_,j,Y,$;m.parameters={...m.parameters,docs:{...(K=m.parameters)==null?void 0:K.docs,source:{originalSource:`{
...
}`,...(i4=(a4=w.parameters)==null?void 0:a4.docs)==null?void 0:i4.source},description:{story:"7. Добавление к уже закреплённому: task закреплён, выделяем Type и закрепляем — оба.",...(s4=(r4=w.parameters)==null?void 0:r4.docs)==null?void 0:s4.description}}};var o4,c4,l4,p4,d4;y.parameters={...y.parameters,docs:{...(o4=y.parameters)==null?void 0:o4.docs,source:{originalSource:`{
...
}`,...(l4=(c4=y.parameters)==null?void 0:c4.docs)==null?void 0:l4.source},description:{story:"8. Выборочное открепление: из двух закреплённых открепляем только выбранный.",...(d4=(p4=y.parameters)==null?void 0:p4.docs)==null?void 0:d4.description}}};const p0=["DropdownOpens","PinSingleViaDropdown","PinViaLeftIcon","PinRangeViaDropdown","UnpinViaLeftIcon","UnpinAllViaDropdown","AddPinToExisting","UnpinSelectedKeepsOthers"];export{w as AddPinToExisting,l as DropdownOpens,m as PinRangeViaDropdown,p as PinSingleViaDropdown,d as PinViaLeftIcon,B as UnpinAllViaDropdown,y as UnpinSelectedKeepsOthers,E as UnpinViaLeftIcon,p0 as __namedExportsOrder,l0 as default};
