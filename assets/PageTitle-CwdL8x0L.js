import{r as y,d as e}from"./react-D2T61mpp.js";import{T as f}from"./AnalyticalWidget-Dpk1hd6s.js";import{w as v}from"./@salutejs/sdds-themes-p9DCXULv.js";import{a as n,f as S,d as w}from"./utils-CLSMcwW8.js";import{s as o}from"./constants-Ci5uyz-N.js";import{H as l,C as g}from"./styled-components-Bm5ATt6S.js";import{a4 as V,I as $}from"./@salutejs/sdds-finai-D4KNbPPv.js";import{eZ as j}from"./@salutejs/plasma-icons-C9x_65-Y.js";const a="PageTitle__",t={root:`${a}root`,breadcrumbs:`${a}breadcrumbs`,content:`${a}content`,leftBlock:`${a}left-block`,titleBlock:`${a}title-block`,title:`${a}title`,subtitle:`${a}subtitle`,titleSlot:`${a}title-slot`,rightBlock:`${a}right-block`,backIconButton:`${a}back-icon-block`},q=l.div.attrs({className:t.root})`
  width: 100%;
  display: flex;
...
Можно передать ReactNode или callback с размерами для адаптива.`,name:"rightSlot",required:!1,type:{name:"PageTitleAdaptiveSlot"}},breadcrumbs:{defaultValue:null,description:`Пропсы для Breadcrumbs компонента
